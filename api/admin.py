...
from .models import (
    ...
    UserProfile, Resident, Family, Notification, NotificationRead
)
...
class SocialWorkerAdmin(admin.ModelAdmin):
    list_display = ('name', 'community', 'gender', 'phone', 'birth_date', 'is_secretary', 'is_baned')
...
class BuildingAdmin(admin.ModelAdmin):
    list_display = ('estate', 'name', 'building_type', 'total_floors', 'units_per_floor')
    search_fields = ('name',)
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'role', 'name', 'phone', 'department')
    search_fields = ('user__username', 'name', 'phone')
    list_filter = ('role', 'department')

class ResidentAdmin(admin.ModelAdmin):
    list_display = ('name', 'gender', 'nationality', 'id_card', 'phone', 'family', 'political_status', 'marital_status', 'education', 'job', 'is_dead')
    search_fields = ('name', 'id_card', 'phone')
    list_filter = ('gender', 'nationality', 'political_status', 'marital_status', 'education', 'job', 'is_dead')
    readonly_fields = ('id_card',)

class FamilyAdmin(admin.ModelAdmin):
    list_display = ('household_number', 'owner_name', 'residential_address', 'contact_phone')
    search_fields = ('household_number', 'owner_name')
    list_filter = ('residential_address__address_type',)

class NotificationAdmin(admin.ModelAdmin):
    list_display = ('title', 'notification_type', 'publisher', 'publish_time', 'valid_until', 'view_count')
