...
from api.views import (
    ...
    NotificationReadViewSet, test_view, index, dashboard, residents_view,
    families_view, notifications_view, analytics_view, addresses_view,
    settings_view, test_auth, add_resident, edit_resident, delete_resident
)
...
urlpatterns = [
    ...
    path('edit-resident/<int:resident_id>/',
         edit_resident, name='edit_resident'),
    # 删除居民路由
    path('delete-resident/<int:resident_id>/',
         delete_resident, name='delete_resident'),
]
